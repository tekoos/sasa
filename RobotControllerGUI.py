...
def open_main_window():
    ...
    side_img = CTkImage(dark_image=side_img_data, light_image=side_img_data, size=(725, 600))
    ...
    img_nav = Image.open("Navigation.png").resize((300, 100), Image.LANCZOS)
    img_off = Image.open("AI.png").resize((300, 100), Image.LANCZOS)
    img_hos = Image.open("Hospital.png").resize((300, 100), Image.LANCZOS)
    img_talk = Image.open("talk.png").resize((300, 100), Image.LANCZOS)
    ...
    btn_frame1 = tk.Frame(button_frame, width=300, height=120)
    ...
    btn_frame2 = tk.Frame(button_frame, width=300, height=120)
    ...
    btn_frame3 = tk.Frame(button_frame, width=300, height=120)
    ...
    btn_frame4 = tk.Frame(button_frame, width=300, height=120)
    btn_frame4.pack_propagate(0)
    btn_frame4.pack(pady=10)
...
def open_clinic_options_window():
    ...
    clinic_options_window.geometry("1024x600")
...
def open_colored_window(title, color):
    ...
    colored_window.geometry("1024x600")
...
def create_TALK_WITH_ME_window(parent):
    ...
    talk_with_me_window.geometry("1024x600")
...
side_img = CTkImage(dark_image=side_img_data, light_image=side_img_data, size=(730, 600))
